<?php
/**
 * Archive & Category Template - Titan Flow Valves
 *
...
<main id="primary" class="site-main">
    ...
    <section class="titan-page-header">
        <div class="titan-container">
            <h1 class="titan-page-header-title"><?php the_archive_title(); ?></h1>
        ...
        <div class="titan-container">
            ...
            <?php else : ?>
                <div class="text-center" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <p>There are no articles available in this archive currently.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
